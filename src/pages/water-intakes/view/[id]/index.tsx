...
import { getWaterIntakeById } from 'apiSdk/water-intakes';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Water Intake Detail View
          </Text>
          {hasAccess('water_intake', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/water-intakes/edit/${data?.id}`} passHref legacyBehavior>
              <Button
                ...
                <Flex alignItems="center" mb={4}>
                  ...
                  <Text fontSize="md" as="span" ml={3}>
                    <Link as={NextLink} href={`/employees/view/${data?.employee?.id}`}>
                      {data?.employee?.daily_water_goal}
                    </Link>
                  </Text>
                </Flex>
              )}
